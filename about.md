...
<section class="section shell">
  <header class="page-intro">
    <span class="mono-label">Our story</span>
    <h1 class="page-title">Crypto news for everyone, minus the noise.</h1>
    <p class="page-sub">Most crypto media is written for Silicon Valley or Dubai whales. We write for the reader checking charts on their phone during lunch break, anywhere from Indore to Indiana.</p>
  </header>

  <div class="prose" style="max-width:46rem;">
    <p>The DESI Sikka started because reading crypto news felt like homework. One site hypes every pump. Another buries you in jargon. A third wants your email before showing you a single fact.</p>
    ...
    <p>Stories come from <strong>{{ site.default_author.name }}</strong>, a team of journalists working around the clock to gather, verify and report crypto news, market analysis and policy updates.</p>
